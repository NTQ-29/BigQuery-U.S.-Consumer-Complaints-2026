...
Within GCP BigQuery utilizing Looker Studio, I've Extracted a sample dataset from the Consumer Financial Protection Bureau and the Consumer Complaint Database. Utilized Data Manipulation, Data Validation, and performed this project to display ETL data pipeline through a cloud-based, Hyperscaler SQL Analytics AI platform
